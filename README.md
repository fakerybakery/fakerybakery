...
I've been working on [@getlinkshort](https://github.com/getlinkshort) and [@snippetsapp](https://github.com/snippetsapp) lately (both in PHP).  I created [Flarum in a Nutshell](https://github.com/getfian) to easily install Flarum.
